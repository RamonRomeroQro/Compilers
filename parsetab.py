...
_lr_productions = [
  ...
  ('statements -> T statement T statements','statements',4,'p_statements','parser.py',22),
  ('statements -> T statement T','statements',3,'p_statements','parser.py',23),
  ('T -> T newline','T',2,'p_T','parser.py',26),
  ('T -> <empty>','T',0,'p_T','parser.py',27),
  ('statement -> var_declaration','statement',1,'p_statement','parser.py',32),
  ...
  ('statement -> input_statement','statement',1,'p_statement','parser.py',36),
  ('input_statement -> INPUT_I','input_statement',1,'p_input_statement','parser.py',42),
  ('input_statement -> INPUT_S','input_statement',1,'p_input_statement','parser.py',43),
  ('print_statement -> PRINT lit_value SEMICOLON','print_statement',3,'p_print_statement','parser.py',48),
  ('print_statement -> PRINT expression SEMICOLON','print_statement',3,'p_print_statement','parser.py',49),
  ('print_statement -> PRINT ID SEMICOLON','print_statement',3,'p_print_statement','parser.py',50),
  ('var_declaration -> ID ASS_OP lit_value SEMICOLON','var_declaration',4,'p_var_declaration','parser.py',55),
  ('var_declaration -> ID ASS_OP expression SEMICOLON','var_declaration',4,'p_var_declaration','parser.py',56),
  ('var_declaration -> ID ASS_OP ID SEMICOLON','var_declaration',4,'p_var_declaration','parser.py',57),
  ('var_declaration -> ID ASS_OP input_statement SEMICOLON','var_declaration',4,'p_var_declaration','parser.py',58),
  ('if_statement -> IF expression THEN statements END','if_statement',5,'p_if_statement','parser.py',63),
  ('if_statement -> IF expression THEN statements ELSE statements END','if_statement',7,'p_if_statement','parser.py',64),
  ('while_statement -> WHILE expression DO statements END','while_statement',5,'p_while_statement','parser.py',70),
  ('expression -> math_expression','expression',1,'p_expression','parser.py',75),
  ('expression -> MINUS math_expression','expression',2,'p_expression','parser.py',76),
  ('expression -> relational_expression','expression',1,'p_expression','parser.py',77),
  ('math_expression -> term PLUS math_expression','math_expression',3,'p_math_expression','parser.py',82),
  ('math_expression -> term MINUS math_expression','math_expression',3,'p_math_expression','parser.py',83),
  ('math_expression -> term','math_expression',1,'p_math_expression','parser.py',84),
  ('relational_expression -> math_expression relational_op math_expression','relational_expression',3,'p_relational_expression','parser.py',89),
  ('relational_expression -> NOT math_expression','relational_expression',2,'p_relational_expression','parser.py',90),
  ('term -> factor TIMES term','term',3,'p_term','parser.py',95),
  ('term -> factor DIVIDE term','term',3,'p_term','parser.py',96),
  ('term -> factor MODULO term','term',3,'p_term','parser.py',97),
  ('term -> factor','term',1,'p_term','parser.py',98),
  ('factor -> lit_value','factor',1,'p_factor','parser.py',104),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','parser.py',105),
  ('factor -> ID','factor',1,'p_factor','parser.py',106),
  ('relational_op -> AND','relational_op',1,'p_relational_op','parser.py',111),
  ('relational_op -> OR','relational_op',1,'p_relational_op','parser.py',112),
  ('relational_op -> GT','relational_op',1,'p_relational_op','parser.py',113),
  ('relational_op -> LT','relational_op',1,'p_relational_op','parser.py',114),
  ('relational_op -> GE','relational_op',1,'p_relational_op','parser.py',115),
  ('relational_op -> LE','relational_op',1,'p_relational_op','parser.py',116),
  ('relational_op -> NE','relational_op',1,'p_relational_op','parser.py',117),
  ('relational_op -> EQ','relational_op',1,'p_relational_op','parser.py',118),
  ('lit_value -> INTEGER','lit_value',1,'p_lit_value','parser.py',122),
  ('lit_value -> STRING','lit_value',1,'p_lit_value','parser.py',123),
  ('lit_value -> BOOL','lit_value',1,'p_lit_value','parser.py',124),
]
